...
Scenarios schedule load according to the number of [virtual users (VUs)](https://grafana.com/docs/k6/<K6_VERSION>/get-started/running-k6/), number of iterations, VUs, or by iteration rate.
